...
<body>
        ...
        <nav class="navbar_custom nav-container">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    ...
                    <!-- <li class="nav__item">
                        <a href="spiderChartAnalysis.php" target="_self" class="nav__link">Spider Chart Analysis</a>
                    </li> -->
                </ul>
            </div>
    ...
    <div>
        <div class="profile-details">
            ...
            $sql = "SELECT f_name, l_name, userType FROM students where s_id = '$id'";
            ...
            </div><div class="card card_1 col-sm-6 mb-3 mb-sm-0">
            <div class="card-body ">
